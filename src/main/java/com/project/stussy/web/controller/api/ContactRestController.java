...
public class ContactRestController {
	...
	// 문의사항 작성
	@PostMapping("")
	public ResponseEntity<?> addContact(AddContactReqDto addContactReqDto) {
	...
	@DeleteMapping("/view/{contactCode}")
